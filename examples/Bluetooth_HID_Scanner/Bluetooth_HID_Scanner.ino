/* 
 *  This sketch demonstrates how to turn the Scangenie into a Bluetooth HID keyboard.
 *  When a barcode is scanned, it will be typed out by the ESP32 over Bluetooth.
 */
...
BleKeyboard bleKeyboard("Scangenie HID", "SB Components", 100);
